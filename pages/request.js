...
const RequestPage = () => {
  ...
  return (
    <Layout>
      <div className="relative w-full h-[80vh] min-h-[600px] my-4 rounded-md overflow-hidden ">
        <Image
        ...
        />
        {!success && !submitted && (
          <SubmitRequest submit={handleSubmit} link={link} setLink={setLink} />
        )}
        {!success && submitted && (
          <UserInfoRequest
            cancel={() => {
