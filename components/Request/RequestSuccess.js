...
const RequestSuccess = () => {
    return <div className='absolute flex items-center justify-center w-full h-full'>
        <div className="flex flex-col items-center w-10/12 max-w-2xl p-4 border rounded-md shadow-md bg-d-bg-color border-d-border-gray">
            ...
            <p className="text-center ">سفارش شما در اسرع وقت بررسی و برآورد هزینه می شود.</p>
            <p className="pb-2 text-center border-b">شما می توانید از طریق داشبورد در قسمت «سفارش های من» از وضعیت سفارش خود مطلع شوید.</p>
